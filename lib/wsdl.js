...
var ElementTypeMap = {
    ...
    definitions: [DefinitionsElement, 'Policy types message portType binding service documentation'],
    documentation: [DocumentationElement, ''],
    Policy: [DocumentationElement, '']
};
...
WSDL.prototype.objectToXML = function(obj, name, namespace, xmlns, first) {
    var self = this,
        parts = [],
        xmlnsAttrib = first ? ' xmlns:'+namespace+'="'+xmlns+'"' : '', ns = namespace ? namespace + ':' : '';
